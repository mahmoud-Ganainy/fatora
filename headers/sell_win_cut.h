#ifndef SELL_WIN_CUT_H
#define SELL_WIN_CUT_H
...
class sell_win_cut : public QMainWindow
{
    Q_OBJECT

public:
    explicit sell_win_cut(QWidget *parent = 0);
    ~sell_win_cut();
    void clear_test();
...
private slots:
    ...
    void on_custom_check_stateChanged(int arg1);

    void on_custom_rec_returnPressed();
